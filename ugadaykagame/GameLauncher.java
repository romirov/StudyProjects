/*
Три игрока пытаются угадать число от 0 до 9.
Кто угадал, тот и выиграл.
*/
/*перенесено в файл GuessGame.java
...
*/
//импортируем GuessGame
import ugadaykagame.GuessGame;
/* перенесено в файл Player.java. Класс импортируется в GuessGame.java
public class Player{
